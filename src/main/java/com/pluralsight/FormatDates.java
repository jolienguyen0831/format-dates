...
public class FormatDates {
    public static void main(String[] args) {
        ...
        DateTimeFormatter formatter2 = DateTimeFormatter.ofPattern("EEEE dd, yyyy");
        String format2 = localDateTime.format(formatter2);
        System.out.println(format2);

        ZonedDateTime gmtTime = ZonedDateTime.now(ZoneId.of("GMT"));
        DateTimeFormatter formatter3 = DateTimeFormatter.ofPattern("EEEE, MMM dd, yyyy HH:mm");
        String format3 = gmtTime.format(formatter3);
        System.out.println(format3);

        ZonedDateTime cstTime = ZonedDateTime.now(ZoneId.of("America/Chicago"));
        DateTimeFormatter formatter4 = DateTimeFormatter.ofPattern("HH:mm 'on' dd-MM-yyyy");
